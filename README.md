...
Three-client salon game, Demo 35: pluck white hairs, cut bangs, and plant hair. Includes local models, sounds, fonts, and face tracking files.

Play: https://belendali.github.io/hair-salon/
...
Actual iPhone and Android camera/performance testing should be completed by testers. Automated checks do not replace device testing.
